...
import Project_2 from './Projects/Project_2/Project_2.jsx'
import './style.styl'
...
const Links = () => (
  <nav className='navigationLinks'>
    ...
    <Link to='/html/Yaroslav_Grushchak/Project_1'>Project 1 (React website)</Link>
      <Link to='/html/Yaroslav_Grushchak/Project_2'>Project 2 (Gallery)</Link>
      ...
      <div>
        ...
        <Switch>                                                              {/* Switch рендерит только первый Route, который подходит под условие */}
          ...
          <Route path='/html/Yaroslav_Grushchak/Project_1' component={Project_1} />
            <Route path='/html/Yaroslav_Grushchak/Project_2' component={Project_2} />
